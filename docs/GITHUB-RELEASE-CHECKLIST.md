...
- [ ] Ubuntu：`apt install`、GNOME 扩展启停/卸载、Wayland 多窗口锚定、两档尺寸、紧凑圆球在普通/全屏/完全最大化/半屏平铺/单轴最大化/过矮宿主下从默认 24 px 桌面坐标锚点上移 136 逻辑 px 的位置规则、托盘关闭恢复、手动刷新。
...
0.1.9、0.1.10 和 0.1.11 旧版 Debian 测试包应继续保留，且原有校验和不变。
