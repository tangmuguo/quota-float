...
const preferences: WidgetPreferences = { locked: false, panelVisible: true, expanded: true, alwaysOnTop: true, position: null, pinnedProvider: "codex", autoRotateSeconds: 12, language: "en" };
